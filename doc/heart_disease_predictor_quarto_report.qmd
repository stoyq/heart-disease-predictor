...
Data validation include all the following:
...
![SVC Confusion Matrix](../results/model_confusion_matrix.png){#fig-confusion width=70%}
...
The confusion matrix (@fig-confusion) shows that the model captures meaningful patterns but sometimes misclassifies borderline cases. Additional feature engineering or alternative models may improve performance.
